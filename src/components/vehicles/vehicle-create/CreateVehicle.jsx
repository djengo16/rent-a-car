            ...
            <Col lg="6">
              ...
              >
                ...
                <Form.Control
                  ...
                  onChange={onInputChange}
                >
                  <option key={1000 + count} disabled>
                    Select model...
                  </option>
                  {models &&
                    models.map((model) => (
                      <option key={1000 + count++}>{model}</option>
                    ))}
                </Form.Control>
              </Form.Group>
              <Form.Group
              ...
              >
                ...
                >
                  ...
                  {vehicleTypes.map((type) => (
                    <option key={2000 + count++}>{type}</option>
                  ))}
                </Form.Control>
              </Form.Group>
              <Form.Group
